...
def plot_pt_eff(particles):
    ...
    if "pt" in particles:
        ...
        # np.histogram would returns the count of each values from input
        # bins would define the range list, the values in the range would be considered as the same value
        # This step would slice the particle by each range of pt values
        ...
        # Save the plot
        fig.savefig('../../metrics/pt_efficiency.png')